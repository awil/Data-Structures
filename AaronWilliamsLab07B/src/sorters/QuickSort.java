 ...
 * Description:		This program demonstrates a selection of sorting
					algorithms from the text but in reverse.
 */
package sorters;
...
public class QuickSort {
	 ...
	 * Postcondition: The resulting array will be sorted into descending order
	 */
	 ...
	 * Postcondition: The resulting array will be sorted in descending order
	 */
