...
public class NQueens {
	...
	public boolean place(int column) {
		...
		// placed, return placeQueen
			...
			while (!placeQueen && (row < board.length)) {
				...
				// Find the next available spot that can hold a queen
					...
					// Place a queen there
					set(row, column);
					// Start at the next column and place a queen
					placeQueen = place(column+1);
					if (!placeQueen) {
